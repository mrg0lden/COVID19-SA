[English](#covid)
<div dir="rtl">
<h1 align="center">إخلاء مسؤولية</h1>
<h2>تجميع هذه البيانات جهد شخصي، حرصت فيه على بذل أقصى الجهد لجمعها من المصادر الرسمية (مذكورة بالأسفل). لكن يجب ألا تعامل معاملة المصادر الرسمية، ولا تعتبر مصدرًا منها.</h2>


<h1>بيانات جائحة الفيروس التاجي المستجد السعودية</h1>
...
✔ ~~إضافة تفاصيل الحالات المتعلقة بالمدن في ملف آخر~~

<h2>المساهمة</h2>
مرحبٌ بها! ولكن يجب إرفاق المصدر الذي حَصل منه على المعلومات في طلب الدمج
(Pull Request)
